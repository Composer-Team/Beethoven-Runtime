...
vcs +vcs+loopreport +v2k -kdb -timescale=1ps/1ps -debug_access $VERDI_HOME/share/PLI/VCS/LINUX64/pli.a -sverilog +incdir+$SDIR -full64 +vpi+1 -CFLAGS -std=c++17 -P ../scripts/tab.tab  +define+CLOCK_PERIOD=500 -f $SLIST libBeethovenRuntime.a $BEETHOVEN_PATH/lib/libdramsim3.so -lrt -L/usr/local/lib64 -lbeethoven -CFLAGS -I$SDIR $SDIR/BeethovenTopVCSHarness.v -o BeethovenTop
