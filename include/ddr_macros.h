...
#define access_w(dnum) ((char*)top.mem_ ## dnum ## _w_bits_data.m_storage)
#define access_r(dnum) ((char*)top.mem_ ## dnum ## _r_bits_data.m_storage)
#else
...
axi4_mems[DDR_NUM].aw = new v_address_channel<ComposerMemIDDtype>(top.mem_ ## DDR_NUM ## _aw_ready, \
...
axi4_mems[DDR_NUM].ar = new v_address_channel<ComposerMemIDDtype>(top.mem_ ## DDR_NUM ## _ar_ready, \
...
axi4_mems[DDR_NUM].b = new response_channel<ComposerMemIDDtype>(top.mem_ ## DDR_NUM ## _b_ready, \
